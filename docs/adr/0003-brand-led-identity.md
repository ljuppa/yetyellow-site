# ADR 0003: Lead with Yetyellow, not the personal name
...
Use Yetyellow as the primary identity in navigation, page titles and visual branding. Show the personal name only on the About page.
